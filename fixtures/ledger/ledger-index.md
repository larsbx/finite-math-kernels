...
**Status:** Generated by tools/generate_ledgers.py from example.json; do not edit. Each row's status label is the ledger class; the closure column is the proof-records dependency closure of the record (complete, or the missing links).
