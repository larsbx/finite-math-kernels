---
name: steward
description: Repository-specific guidance for driving a pull request in finite-math-kernels to a green, mergeable state — the gates to run before pushing, what this repository accepts as evidence, and what it never allows. Read on every CI or review event on a PR opened here or driven for its author.
---
...
# Stewarding a pull request in finite-math-kernels
